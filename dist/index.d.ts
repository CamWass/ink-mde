...
declare const inkPlugin: <T extends "default" | "completion" | "grammar" | "language">({ key, type, value }: {
    key?: string | undefined;
    type?: T | undefined;
    value: () => PluginValueForType<T>;
}) => Options.Plugin;
declare const plugin: <T extends "default" | "completion" | "grammar" | "language">({ key, type, value }: {
    key?: string | undefined;
    type?: T | undefined;
    value: () => PluginValueForType<T>;
}) => Options.Plugin;
