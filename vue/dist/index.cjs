...
const _sfc_main = vue.defineComponent({
  ...
  created() {
    {
      this.html = inkMde.renderToString(this.options);
    }
  },
  mounted() {
    this.tryInit();
  ...
  methods: {
    tryInit() {
      ...
      if (this.$refs.ink && !this.instance) {
        this.instance = inkMde.ink(this.$refs.ink, {
          ...this.options,
          doc: this.modelValue,
          hooks: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.ssrRenderAttrs(vue.mergeProps({ ref: "ink" }, _attrs))}>${_ctx.html ?? ""}</div>`);
}
...
exports.InkMde = InkMde;
exports.default = InkMde;
